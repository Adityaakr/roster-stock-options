        ...
        <div style={{ display: "grid", gap: 16, alignContent: "start" }}>
          ...
          <div className="card pad">
            ...
            <div style={{ marginTop: 10, display: "grid", gap: 8 }}>
              {bestGap[0] ? <Link className="term-pick" href={`/trade/${bestGap[0].id}`} data-testid="buy-gap"><span><b>Buy an Upside</b> <span className="muted">${usdK(bestGap[0].strike)} · {dayLabel(bestGap[0].expiryTs)}</span></span><span className="mono">${usd(bestGap[0].ladder[0]!.ask!)} / share</span><span className="pick-go">Buy →</span></Link> : <div className="small muted">No Upside quoted right now.</div>}
