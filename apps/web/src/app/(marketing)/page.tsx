...
import { BrandStrip, Counters, Cta, FirstPrint, Hero, Products, Risk, SaidOutLoud, WhatThisIsNot, Workflow } from "@/components/landing/sections";
...
const SOCIAL = "Trade Nvidia's upside on Solana with a fully paid contract. Know your maximum loss before you buy. No borrowing, no funding, no margin calls.";
