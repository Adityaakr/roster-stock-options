...
const QA: [string, string][] = [
  ...
  ["What if the oracle goes down?", "Then nobody can buy, and everybody can still leave. Every ask is priced off Pyth and the quoter pulls its quotes when the feed is stale, but exercise is a fixed swap between two escrows and reads no price at all. A closed market, a stale feed or a Hermes outage can stop you entering, never stop you leaving. The one convenience that does read a price is the opt-in auto-exercise crank, and it can be revoked."],
